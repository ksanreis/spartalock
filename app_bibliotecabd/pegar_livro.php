    ...
    <div class="card-pegar-livro">
      <div class="card">
        <div class="card-header">
          <p style="color:black;">Pedir Livro</p>
        </div>
        <div class="card-body">
          <div class="row">
            ...
            <form action="registra_livro.php" method="post">
              <div class="form-group ">
                ...
                <select name="titulo" class="form-control">
                  ...
                  <option>Acessibilidade na Web</option>
                  <option>Introdução e boas práticas em UX Design</option>
                  <option>React Native</option>
                  <option>Front-end com Vue.js</option>
                  <option> Angular 8 e Firebase</option>
